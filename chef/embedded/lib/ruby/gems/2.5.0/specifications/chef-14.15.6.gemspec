...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<chef-config>.freeze, ["= 14.15.6"])
      ...
      s.add_runtime_dependency(%q<chef-zero>.freeze, [">= 13.0", "< 15.0"])
      ...
      s.add_dependency(%q<chef-config>.freeze, ["= 14.15.6"])
      ...
      s.add_dependency(%q<chef-zero>.freeze, [">= 13.0", "< 15.0"])
